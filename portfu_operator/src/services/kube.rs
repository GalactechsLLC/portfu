...
pub async fn get_ingress(
    ...
    list_params: Json<Option<SearchParams>>,
) -> Result<ObjectList<Ingress>, Error> {
...
pub async fn get_services(
    ...
    namespace: State<KubeNamespace>,
    list_params: Json<Option<SearchParams>>,
) -> Result<ObjectList<KubeService>, Error> {
    let api: Api<KubeService> =
...
pub async fn get_configs(
    ...
    namespace: State<KubeNamespace>,
    list_params: Json<Option<SearchParams>>,
) -> Result<ObjectList<ConfigMap>, Error> {
...
pub async fn get_volume_claims(
    ...
    namespace: State<KubeNamespace>,
    list_params: Json<Option<SearchParams>>,
) -> Result<ObjectList<PersistentVolumeClaim>, Error> {
...
pub async fn get_volumes(
    client: State<Client>,
    list_params: Json<Option<SearchParams>>,
) -> Result<ObjectList<PersistentVolume>, Error> {
...
pub async fn get_storage_classes(
    client: State<Client>,
    list_params: Json<Option<SearchParams>>,
) -> Result<ObjectList<StorageClass>, Error> {
...
pub async fn get_namespaces(
    client: State<Client>,
    list_params: Json<Option<SearchParams>>,
) -> Result<ObjectList<Namespace>, Error> {
